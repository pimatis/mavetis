...
var controlMap = map[string][]string{
	...
	"webhook.signature.missing":            {"OWASP-ASVS-V4.1", "OWASP-ASVS-V6.2"},
	"webhook.replay.window.missing":        {"OWASP-ASVS-V4.1"},
	"webhook.rawbody.missing":              {"OWASP-ASVS-V4.1"},
	"authorization.tenant.lookup.missing":  {"OWASP-ASVS-V4.1"},
	"authorization.cross.tenant.query":     {"OWASP-ASVS-V4.1"},
	"auth.reset.token.logged":              {"OWASP-ASVS-V2.1", "OWASP-ASVS-V8.1"},
	"auth.password.change.without.current": {"OWASP-ASVS-V2.1"},
	"cloud.storage.public.read":            {"OWASP-ASVS-V14.4"},
	"cloud.storage.public.write":           {"OWASP-ASVS-V14.4"},
	"cloud.storage.presigned.longlived":    {"OWASP-ASVS-V14.4"},
